#!/bin/bash
# Full pipeline: .obj -> .msh -> FEM simulation (GPU version)
# Usage: ./run_pipeline_gpu.sh path/to/model.obj
...
echo "=== Pipeline (GPU) for: $BASENAME ==="
...
# Step 3: Run FEM simulation on GPU
echo "Step 3: Running FEM simulation on GPU..."
python fed_test_gpu.py "$BASENAME"
